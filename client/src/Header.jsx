    ...
    return (
        ...
        <header className="flex p-5 font-semibold justify-between">
            ...
            <div className="  h-12 flex border border-gray-300 rounded-full px-20  gap-10 shadow-md shadow-gray-350">
                ...
                <div className=" flex items-center font-semibold "><Link className="" to={'/quizzes'}> Quizzes</Link></div>
                <div className="border-l border-gray-300"></div>
                <div className=" flex items-center font-semibold "><Link className="" to={'/learning'}> Learning</Link></div>
                <div className="border-l border-gray-300"></div>
                <div className=" flex items-center font-semibold "><Link className="" to={'/chatgpt'}> WealthWhizz</Link></div>
