...
export default function GamePage() {
    ...
    // Message about the AI Revolution
    const aiRevolutionMessage = "The world is experiencing a transformative AI revolution. Stay ahead by investing wisely.";
    ...
    const loadRandomImage = () => {
        const imageUrls = [
            ...
            'https://www.investopedia.com/thmb/rb9p2s6sixjdprbwknjsx4gf_xg=/2774x0/filters:no_upscale():max_bytes(150000):strip_icc()/dotdash_final_introduction_to_technical_analysis_price_patterns_sep_2020-05-437d981a36724a8c9892a7806d2315ec.jpg',
            // Add more image URLs
        ];
    ...
    return (
        <div className='min-h-screen bg-gradient-to-b from-blue-700 to-blue-900 text-white flex flex-col'>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className="border border-dark p-4 rounded mt-10">
                    <p className="text-white">{aiRevolutionMessage}</p>
                </div>
